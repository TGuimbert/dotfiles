...
{
  homeManager.modules = {
    base.imports = [ config.homeManager.modules.helix ];
    gui.imports = [ config.homeManager.modules.helixLanguages ];
    ...
    helix = { lib, ... }: {
      programs.helix = {
        ...
        settings = {
          ...
          theme = lib.mkDefault "term16-flat";
    ...
    helixLanguages =
      { pkgs, ... }:
      {
        imports = [ config.homeManager.modules.helix ];
        programs.helix = {
